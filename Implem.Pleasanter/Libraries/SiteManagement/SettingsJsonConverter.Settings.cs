...
namespace Implem.Pleasanter.Libraries.SiteManagement
{
    public partial class SettingsJsonConverter
    {
            ...
            Param param)
        {
            ...
            {
                var r = SiteSettingData.ConvertSite(context: context, param: param, siteId: siteId.SiteId, ver: siteId.Ver);
                if (r == null) continue;
                (s.Sites ??= new()).Add(r);
            }
            return s;
        ...
        public class SiteSettingData
        {
            ...
            internal static Site ConvertSite(
                Context context,
                Param param,
                long siteId,
                long ver = 0)
            {
                ...
                {
                    var item = new Log(Log.LogLevel.Error, "ConvertSite", $"SiteId {siteId} ver {ver} conversion failed. {e.Message}");
                    if (site != null)
                    {
                        param.Logs.Add(item);
                    }
